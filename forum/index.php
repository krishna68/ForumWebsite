    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/new.jpeg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/new1.jpeg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/new.jpeg" class="d-block w-100" alt="...">
            </div>
    ...
    <h2 class="text-center my-3">iDiscuss-Categories</h2>
     <div class="row">   
        ...
        while($row=mysqli_fetch_assoc($result)){
          ...
          <img src="https://source.unsplash.com/random/400x200/?'.$cat.',coding" class="card-img-top"
              alt="...">
                <div class="card-body">
